...
class TictacGame():
    ...
    def game_status(self):
        ...
        logging.info("contains: active_player, game_round, game_finished, grid_slots 1-9[index starts at 0])")
        return(self.active_player, self.game_round, self.game_finished, self.grid)
...
#logging.getLogger().setLevel(logging.INFO)#uncomment to see info logs in command line during testing
tictac = TictacGame()
tictac.start_game()
